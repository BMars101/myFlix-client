...
}(_react.default.Component); //finds the root of app


var container = document.getElementsByClassName('app-container')[0]; //tells React to render app on the root DOM element
